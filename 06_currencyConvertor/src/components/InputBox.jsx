        ...
        <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
            <div className="w-1/2">
                ...
                <input
                    ...
                    // If onAmountChange is given (not undefined), then call it with the selected currency.
            ...
            <div className="w-1/2 flex flex-wrap justify-end text-right">
                ...
                <select
                    ...
                    // If onCurrencyChange is given (not undefined), then call it with the selected currency.
